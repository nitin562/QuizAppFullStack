...
export default function Home() {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center  gap-x-4 bg-black/50 before:contents-[''] before:w-full before:h-full before:absolute before:top-0 before:left-0  before:bg-[url('./Bg.webp')] before:z-[-10] before:bg-center before:bg-cover before:bg-no-repeat ">
